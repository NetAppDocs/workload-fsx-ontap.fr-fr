...
[role="lead"]
Répliquez les données dans NetApp Workload Factory pour vous protéger contre la perte de données si la région où vos données résident subit une catastrophe. La réplication des données est prise en charge entre les systèmes de fichiers FSx for ONTAP et les systèmes ONTAP sur site ou Cloud Volumes ONTAP.
