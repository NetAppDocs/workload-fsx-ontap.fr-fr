...
* Sécurité : Protection autonome contre les ransomwares NetApp avec IA (ARP/AI) désactivée et accès non autorisé aux volumes
* Excellence opérationnelle : gestion automatique de la capacité, seuil d’utilisation de la capacité des fichiers de volume, utilisation du volume proche de la saturation et mode d’écriture basé sur la relation du cache
* Optimisation des coûts : efficacité du stockage, hiérarchisation des données, suppression des instantanés et des sauvegardes inutiles
