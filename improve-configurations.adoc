...
* Sécurité : Protection autonome contre les ransomwares NetApp avec IA (ARP/AI)
* Excellence opérationnelle : efficacité du stockage, gestion automatique de la capacité et seuil d'utilisation de la capacité des fichiers de volume
