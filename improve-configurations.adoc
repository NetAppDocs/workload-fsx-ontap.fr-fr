...
* Optimisation des coûts : efficacités du stockage, hiérarchisation des données, suppression des instantanés et des sauvegardes inutiles, et périphériques de blocs inactifs
