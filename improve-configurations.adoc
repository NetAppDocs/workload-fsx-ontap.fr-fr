...
* Optimisation des coûts : gains d’efficacité en matière de stockage, hiérarchisation des données et suppression inutile des instantanés
* Optimisation des performances : rééquilibrage des volumes FlexGroup
