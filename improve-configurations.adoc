...
* Optimisation des coûts : efficacités de stockage, hiérarchisation des données, suppression des snapshots et des sauvegardes inutiles, périphériques bloc inactifs et capacité SSD sous-utilisée
