...
* Optimisation des coûts : efficacités du stockage, hiérarchisation des données, suppression inutile des instantanés et des sauvegardes, et périphériques bloc orphelins
