...
* Fiabilité : seuil de capacité SSD, instantanés locaux planifiés, sauvegardes de volumes planifiées, réplication des données à distance et fiabilité des données pour la conservation à long terme
