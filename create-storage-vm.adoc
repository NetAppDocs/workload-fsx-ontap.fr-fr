...
. Depuis *FSx for ONTAP*, sélectionnez le menu d'actions du système de fichiers pour lequel créer une machine virtuelle de stockage et sélectionnez *Créer une machine virtuelle de stockage*.
