...
summary: 'La gestion du partage SMB ou CIFS d"un volume dans Workload Factory comprend la création, la détermination des accès des utilisateurs et des groupes, et la suppression.' 
---
= Gérez le partage CIFS d'un volume dans NetApp Workload Factory
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
* Pour gérer les partages SMB/CIFS, vous devez associer un lien. link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["Apprenez à associer un lien existant ou à créer et associer un nouveau lien"^]. Une fois le lien associé, revenez à cette opération.
...
. Sélectionnez le menu Actions du volume pour lequel vous souhaitez modifier le partage SMB.
