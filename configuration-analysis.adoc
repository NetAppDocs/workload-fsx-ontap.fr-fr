...
Pour une analyse complète du système de fichiers, vous devez associer un lien.  La connectivité des liens permet à Workload Factory d'analyser toutes les configurations du système de fichiers, comme la protection des données et les performances.
