...
---
= Activer la croissance automatique du volume dans Workload Factory
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
Vous pouvez également augmenter manuellement la capacité de volume d'un volume à tout moment en utilisant lalink:adjust-volume-capacity.html["fonction de réglage du volume"] .
