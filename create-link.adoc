...
.Créer manuellement
--
Avec cette option, vous extrayez l'ARN du lien et le signalez ici. L'usine de charge de travail enregistre manuellement le lien pour vous. Vous pouvez créer un lien à l'aide de deux outils d'infrastructure en tant que code (IaC) de Codebox : CloudFormation ou Terraform.
