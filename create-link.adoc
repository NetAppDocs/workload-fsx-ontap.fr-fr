...
+
Notez que trois autorisations sont accordées à Lambda lors du lancement du modèle CloudFormation. Workload Factory utilise ces autorisations lors de l'utilisation de liens.
