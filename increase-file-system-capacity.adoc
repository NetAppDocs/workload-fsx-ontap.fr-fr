...
---
= Ajustez manuellement la capacité du système de fichiers dans NetApp Workload Factory
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
Augmentez la capacité de stockage SSD lorsque l'utilisation dépasse votre seuil spécifié. Réduisez la capacité de stockage SSD lorsque vous n'utilisez pas les ensembles de travail afin de réaliser des économies.

Vous pouvez également link:manage-capacity-automatically.html["activer la gestion de la capacité"] faire en sorte que NetApp Workload Factory gère la capacité du système de fichiers pour vous.
