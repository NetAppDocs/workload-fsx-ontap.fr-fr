...
* Pour scinder un volume cloné, vous devez associer un lien. link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["Apprenez à associer un lien existant ou à créer et associer un nouveau lien"^]. Une fois le lien associé, revenez à cette opération.
...
. Sélectionnez le menu Actions du volume avec le volume cloné à diviser.
