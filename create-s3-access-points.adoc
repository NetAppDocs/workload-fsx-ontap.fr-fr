...
. Sélectionnez le menu des actions du volume que vous souhaitez utiliser, puis sélectionnez *Actions avancées*, puis *Gérer les points d'accès S3*.
