...
summary: 'L"activation de cette fonctionnalité permet à Workload Factory d"ajouter automatiquement du stockage incrémentiel à un système de fichiers FSx for ONTAP à mesure que les besoins en capacité évoluent au fil du temps.' 
---
...
[role="lead"]
L'activation de la gestion automatique de la capacité permet à NetApp Workload Factory d'ajouter automatiquement du stockage incrémentiel à un système de fichiers FSx for ONTAP à mesure que les besoins en capacité évoluent au fil du temps.  De plus, l’activation de cette fonctionnalité supprime la nécessité de surveiller manuellement la capacité et atténue le risque de lectures et d’écritures de données d’application impactantes.
