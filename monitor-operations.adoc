...
summary: Suivez les opérations de charge de travail et surveillez la progression des tâches avec Tracker dans NetApp Workload Factory pour FSx for ONTAP. 
---
= Surveillez les opérations FSx for ONTAP avec Tracker
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
