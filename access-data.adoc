...
Vous pouvez également obtenir le point de montage des volumes dans NetApp Workload Factory.



== Obtenir le point de montage des volumes dans NetApp Workload Factory
...
. Dans l'onglet Volumes, sélectionnez le menu d'actions du volume, puis *Actions de base*, puis *Afficher la commande de montage*.
